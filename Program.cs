...
////作法一：
//builder.Services.AddDbContext<MVC_UserDB2Context>(options => options.UseSqlServer("Server=.\\sqlexpress;Database=MVC_UserDB2;Trusted_Connection=True;TrustServerCertificate=true;MultipleActiveResultSets=true"));
